...
{#if user}
   <button {...$trigger} use:trigger aria-label="Open account menu" class="flex p-2 ml-2 items-center justify-center hover:bg-stone-200 rounded-md">
      <span class="sr-only">View account</span>
      <UserCircle2 class="text-gray-800 h-10 w-10" />
   </button>
{:else}
   <a href="/auth">
      <button class="flex p-2 mx-2 items-center justify-center hover:bg-stone-200 rounded-md">
...
<style lang="postcss">
   .menu {
     @apply z-10 flex max-h-[300px] flex-col shadow-lg;
